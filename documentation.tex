...
\begin{itemize}
	...
	\item \nameref{par:setsummary}
	\item \nameref{par:setcurrency}
	\item \nameref{par:setvattext}
	\item \nameref{par:setaccounttext}
...
\subsection{{\textbackslash}setsummary} \label{par:setsummary}
Specify a summary to description of the invoice. This command is optional, and the field is left out if not set. Takes one argument: the message to use as the summary text. Example:
\begin{lstlisting}
\setsummary{This is a short summary of the invoice.}
\end{lstlisting}


\subsection{{\textbackslash}setcurrency} \label{par:setcurrency}
Specify a currency to use in all price fields of the invoice. This command is optional, the default currency is no currency. Takes one argument: the currency code to use. Example:
\begin{lstlisting}
\setcurrency{CAD}
\end{lstlisting}


\subsection{{\textbackslash}setvattext} \label{par:setvattext}
Specify custom text for the VAT labels. This command is optional, the default text is ``VAT''. Takes one argument: the name of the tax use. Example:
\begin{lstlisting}
\setvattext{HST}
\end{lstlisting}


\subsection{{\textbackslash}setaccounttext} \label{par:setaccounttext}
Specify custom text for the account number labels, useful if not receiving payments through a bank transfer. This command is optional, the default text is ``Account number''. Takes one argument: the title of the field. Example:
\begin{lstlisting}
\setaccounttext{Payment via}
\end{lstlisting}
